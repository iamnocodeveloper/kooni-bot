---
name: contribuir
description: Reporta un bug o idea (issue) o manda un arreglo (PR) al repo del template desde Claude Code usando el CLI de GitHub (gh). El usuario no programa; tú corres gh. Actívalo con "/contribuir", "reporta este error", "abre un issue", "manda esto como mejora", "manda un PR", "contribuir a Kooni", "sube este arreglo".
---
