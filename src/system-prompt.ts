...
- TÚ preguntaste si quiere hablar con una persona/el dueño y el cliente responde
  afirmativamente ("sí", "si", "claro", "dale", "ok", "por favor", "adelante").
  No lo re-preguntes: escala en cuanto confirme.
